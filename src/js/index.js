...
function submitProposition(form){
  try {
    ...
    var truth_results = parser.solver(parser.proposition);
    ...
    text.id = "warning";
    text.innerHTML = "Something look wrong? Make sure your expressions are contained within brackets!"
    results_container.appendChild(text);
